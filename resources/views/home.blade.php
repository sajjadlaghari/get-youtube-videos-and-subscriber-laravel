...
<body class="body">
    ...
    <section>
        ...
        <div class="slider multiple-items cusslider">
            ...
            <video style="border-radius:8px; border: 3px solid #fff; width:100%; height: 300px;" class="video-js vjs-default-skin" controls
    ...
    <section>
        ...
        <div class="container text-center ">
            <h1 class="fw-bold text-center youtube-heading" style="color: red">{{$subscribers->subscribers}}</h1>
        </div>
    </section>
